...
;let {result = ((SModel.lg alpha +> SModel.plus_f' alpha pi) +> unitMixture) +> SModel.gammaRates 1.51528598579451 5}
;let {loggers = ["f:pi" %=% pi]}
;return (result, loggers)
}

sample_imodel  topology = IModel.rs07 0.22083670052 3.54825557248 topology
...
;sequenceData <- mkUnalignedCharacterData aa <$> loadSequences "tools/testArena/seq_3/sequences.fasta"
;
