...
;let {result = ((SModel.lg alpha +> SModel.plus_f' alpha pi) +> unitMixture) +> SModel.gammaRates 2.29248166061324 5}
;let {loggers = ["f:pi" %=% pi]}
;return (result, loggers)
}

sample_imodel  topology = IModel.rs07 0.30171420997398 8.39245095542597 topology
...
;sequenceData <- mkUnalignedCharacterData aa <$> loadSequences "data/simulation/SCOPt2e2/seq_1/sequences.fasta"
;
