...
;let {result = SModel.lg alpha +> SModel.plus_f' alpha pi}
;let {loggers = ["f:pi" %=% pi]}
...
;sequenceData <- mkUnalignedCharacterData aa <$> loadSequences "data/simulation/experiment_2/seq_25/raw_seq.fasta"
;
